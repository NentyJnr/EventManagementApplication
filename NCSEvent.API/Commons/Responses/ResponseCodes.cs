namespace NCSEvent.API.Commons.Responses
{
    public class ResponseCodes
    {
        ...
        public const string INVALID_USER = "VAT0021";
        public const string EMAIL_NOT_SENT = "VAT0022";
        public const string INVALID_ROLE = "VAT0023";
        public const string REGITRATION_FAILED = "VAT0024";
        public const string INVALID_MAIL = "VAT0025";
        public const string DUPPLICATE_USERNAME = "VAT0026";
        public const string DATA_ARE_REQUIRED = "VAT0027";
        public const string STARTDATE_GREATER_THAN_ERROR = "VAT0028";
        public const string STARTDATE_LESS_THAN_ERROR = "VAT0029";
        public const string ENDATE_GREATER_THAN_ERROR = "VAT0030";
        public const string INVALID_DEVELOPER = "VAT0031";
        public const string INVALID_DOCUMENT = "VAT0032";
